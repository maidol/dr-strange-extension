//! The drsg java plugin: the parser, wrapped for the wasm contract.
...
impl drsg_java_parser::Files for HostFiles {
...
impl Guest for JavaPlugin {
    fn describe() -> Manifest {
        Manifest {
            ...
            // `java@1` facts is still readable; it simply has none of
