//! The drsg py plugin: the parser, wrapped for the wasm contract.
...
impl drsg_py_parser::Files for HostFiles {
...
impl Guest for PyPlugin {
    fn describe() -> Manifest {
        Manifest {
            ...
            // `py@1` facts is still readable; it simply has none of
