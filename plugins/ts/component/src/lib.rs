//! The drsg ts plugin: the parser, wrapped for the wasm contract.
...
impl drsg_ts_parser::Files for HostFiles {
...
impl Guest for TsPlugin {
    fn describe() -> Manifest {
        Manifest {
            ...
            // `ts@1` facts is still readable; it simply has none of
